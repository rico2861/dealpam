...
let ProductsController = class ProductsController {
    ...
    findAll(filter) { return this.productsService.findAll(filter); }
    getFeatured() { return this.productsService.getFeatured(); }
    getMyProducts(user, page, limit) {
        return this.productsService.getMyProducts(user.seller?.id || user.id, page, limit);
    }
    findOne(slug) { return this.productsService.findOne(slug); }
    async create(user, dto, files) {
    ...
    findAllAdmin(page = 1, limit = 50) {
        return this.productsService.findAllAdmin(Number(page), Number(limit));
    }
    toggleFeatured(id) { return this.productsService.toggleFeatured(id); }
    toggleSponsored(id) { return this.productsService.toggleSponsored(id); }
    approve(id) { return this.productsService.approve(id); }
    reject(id, reason) { return this.productsService.reject(id, reason); }
...
__decorate([
    (0, common_1.Patch)(':id/toggle-sponsored'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('ADMIN', 'SUPER_ADMIN'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ProductsController.prototype, "toggleSponsored", null);
__decorate([
