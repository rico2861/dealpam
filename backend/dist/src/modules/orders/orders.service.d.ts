...
export declare class OrdersService {
    ...
    create(userId: string, addressId: string, notes?: string): Promise<any[]>;
    findMyOrders(userId: string, page?: number, limit?: number): import(".prisma/client").Prisma.PrismaPromise<({
        store: {
            name: string;
            slug: string;
            logoUrl: string;
    ...
    updateStatus(id: string, status: string, sellerId?: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.OrderStatus;
    ...
    findSellerOrders(sellerId: string, page?: number): import(".prisma/client").Prisma.PrismaPromise<({
        user: {
            firstName: string;
            lastName: string;
        };
