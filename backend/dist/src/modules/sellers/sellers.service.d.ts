...
export declare class SellersService {
    ...
    findAll(status?: string, page?: number, limit?: number): import(".prisma/client").Prisma.PrismaPromise<({
        subscriptions: ({
            plan: {
                id: string;
    ...
    getMe(userId: string): import(".prisma/client").Prisma.Prisma__SellerClient<{
        subscriptions: ({
            plan: {
                id: string;
                tier: import(".prisma/client").$Enums.SubscriptionTier;
