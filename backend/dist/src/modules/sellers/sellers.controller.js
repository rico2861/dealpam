...
let SellersController = class SellersController {
    ...
    getMe(u) { return this.sellersService.getMe(u.id); }
    findAll(status, page) { return this.sellersService.findAll(status, page); }
    approve(id, u) { return this.sellersService.approve(id, u.id); }
    reject(id, reason) { return this.sellersService.reject(id, reason); }
    suspend(id) { return this.sellersService.suspend(id); }
    reactivate(id) { return this.sellersService.reactivate(id); }
};
...
], SellersController.prototype, "getMe", null);
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], SellersController.prototype, "reactivate", null);
