...
exports.SellersModule = SellersModule = __decorate([
    (0, common_1.Module)({ providers: [sellers_service_1.SellersService], controllers: [sellers_controller_1.SellersController], exports: [sellers_service_1.SellersService] })
], SellersModule);
