...
let StoresController = class StoresController {
    ...
    findAll(page) { return this.storesService.findAll(page); }
    findBySlug(slug) { return this.storesService.findBySlug(slug); }
    updateMe(u, data) { return this.storesService.updateMe(u.id, data); }
};
