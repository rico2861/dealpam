...
let ReviewsController = class ReviewsController {
    ...
    findByProduct(id) { return this.rs.findByProduct(id); }
    create(u, b) { return this.rs.create(u.id, b); }
    approve(id) { return this.rs.approve(id); }
    delete(id) { return this.rs.delete(id); }
    findAll(p) { return this.rs.findAll(p); }
};
