...
export default function ReviewsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['admin-reviews', dateFrom, dateTo],
    queryFn: () => api.get('/reviews', { params: { limit: 100, dateFrom: dateFrom || undefined, dateTo: dateTo || undefined } })
      .then(r => Array.isArray(r.data) ? r.data : r.data?.data || []).catch(() => []),
  });

  return (
    <Container maxWidth="xl" sx={{ py: 3 }}>
      <Typography variant="h4" fontWeight={800} mb={3}>Reviews</Typography>
