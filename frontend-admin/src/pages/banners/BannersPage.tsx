  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        ...
        <Button variant="contained" startIcon={<Add />} onClick={() => setDialogBanner({ ...EMPTY })}
      ...
      <Alert severity="info" sx={{ mb: 3, borderRadius: 2 }}>
        Les bannières sont affichées par ordre croissant de "Ordre d'affichage". Seules les bannières <strong>actives</strong> et dans la période de validité sont affichées sur la homepage.
      </Alert>
